...
from .views import LinksAPI, Logout, CreateNotesAPI, UpdateNotesAPI, ListNotesAPI, RetriveNotesAPI, DeleteNotesAPI
...
urlpatterns = [
    ...
    path('api/v1/note/<int:pk>', UpdateNotesAPI.as_view()),
